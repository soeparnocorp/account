  ...
  async fetch(request, env, ctx) {
    return await handleErrors(request, async () => {
      ...
      switch (path[0]) {
        ...
        case "auth":
          return await handleAuthRequest(path.slice(1), request, env, ctx);
...
// ============ API HANDLER (EXISTING - TIDAK DIUBAH) ============
...
// ============ AUTH HANDLER (BARU - UNTUK OPENATH) ============
async function handleAuthRequest(path, request, env, ctx) {
  ...
  switch (path[0]) {
    ...
    case "callback": {
      ...
      // TODO: Tukar code dengan token dari OpenAuth
      // Sementara redirect ke home dulu
    ...
    case "me": {
      ...
      // TODO: Validasi token ke OpenAuth
    ...
    case "username": {
      ...
      // TODO: Simpan username di KV dengan key email
...
// ============ DURABLE OBJECT: CHAT ROOM (EXISTING - TIDAK DIUBAH) ============
...
// ============ DURABLE OBJECT: RATE LIMITER (EXISTING) ============
